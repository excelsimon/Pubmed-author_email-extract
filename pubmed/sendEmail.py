     ...
     <table  style="border: 1px solid #cccccc;" align="center" cellpadding="0" cellspacing="0" width="600">
	  ...
	  <tr>
       <td align="center" bgcolor="#ffffff" style="padding: 0 0 0 0;">
        <img src="http://a1.qpic.cn/psb?/V143Ct1g1kfnFK/WMH94R5NtlUFgRfFc1qvvaE**KOICN8lJ5S6HZICA2A!/m/dKwAAAAAAAAAnull&bo=sASnAAAAAAAFBzc!&rf=photolist&t=5" alt="最尖端的技术、最优的服务，打造国际化品牌" width="600" height="100" style="display: block;" />
	   </td>
      </tr>
       ...
       <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
         <tr>
		  ...
		  <p>那么请您关注我们的产品。</p>
          <p>北京华生恒业科技有限公司是一家专业从事应用生物科技软件研发、定制、数据分析的高新科技企业。与美国SoftGenetics长期国际交流合作，开发系列基因测序分析软件。我们的产品有<font color="#FF0000">二代测序数据分析工具NextGene?、Sanger测序数据分析软件Mutation Surveyor?、DNA片段分析软件GeneMarker?</font>，该系列软件具有简单、直观、可视化的界面显示，显著减少用户生物信息学基础的要求，为医生、生物学家、测序服务商等提供了最好的选择。此外我们还开展各类测序数据分析业务、测序分析软件的定制开发，为您提供世界领先的生物软件定制及数据分析服务。</p>
          <p>全球有超过4000家DNA实验室和研究机构使用公司研发的DNA测序数据分析系列软件。美国耶鲁大学医学院儿童健康研究中心、美国路德维格癌症遗传与治疗中心、美国约翰霍普金斯大学癌症研究所、中国科学院北京基因组研究所、芬兰?Nat`l公共卫生研究所、法国?国家科学研究中心、德国?Bioglobe、香港大学、澳大利亚?Anzac Health等等。这些研究机构发表在世界顶级科学杂志（如《Nature》和《Science》）上的文章特别指出了在科研过程中，本公司的软件产品起了重要的作用。</p>
          </td>
         </tr>
		 <tr>
          <td style="padding: 20px 0 0 0;color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;"">
		  1.<font color="#FF0000">NextGene?</font>——<a href="http://www.todaysoft.com.cn/a/products/biotechnology/2010/0914/13.html">二代测序数据分析工具</a>
			<p>NextGENe ?提供了新一代大规模基因测序工程的整套软件解决方案，用于实现序列装配和序列比对，NextGENe在Windows操作系统运行，效率高，准确性高，用户不需具备脚本或者其他生物信息学背景即可应用。并且具备强大的界面显示和报表输出功能，可以分析序列比对结果，查看变异信息等。可分析Ion Torrent 测序平台、Roche测序平台、Illumina 测序平台、SOLiD测序系统产出的原始测序数据，可兼容BAM、FASTQ、FASTA、CSFASTA等多种数据格式。</p>
          </td>
         </tr>
		 <tr>
          <td>
         ...
         <tr>
          <td style="padding: 20px 0 0 0;color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;"">
		  2.<font color="#FF0000">Mutation Surveyor?</font>——<a href="http://www.todaysoft.com.cn/a/products/biotechnology/2010/0914/11.html">Sanger测序数据分析软件</a>
		  <p>Mutation Surveyor?是基因突变(Mutation) 检测软件。可以检测纯合子变异(Homozygote)——SNP、插入/缺失(InDel)，杂合子变异(Heterozygote)——SNP、插入/缺失(InDel)等。它可和标准序列比较，快速找出样本序列图谱中所有的基因变异点。</p>
          <p>Mutation Surveyor?在突变检测领域运用了两项世界首创技术：反相关曲线技术和准确识别插入/缺失杂合子突变技术。</p>
		 ...
		 <tr>
          <td style="padding: 20px 0 0 0;color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;"">
		  3. <font color="#FF0000">GeneMarker?</font>——<a href="http://www.todaysoft.com.cn/a/products/biotechnology/2010/0914/12.html">DNA片段分析软件</a>
		  <p>GeneMarker?软件是唯一为基因研究者设计的“生物学家友好”的基因分型软件，广泛应用于遗传病、肿瘤、法医、农林育种等领域的研究。软件界面具有引导功能并且布局直观，使用非常简便，并集合十余个应用，是一款精确、快速、友好、功能强大的自动化数据分析软件。</p>
		  </td>
         </tr>
		 <tr>
          <td>
		 ...
		 <tr>
          <td style="padding: 20px 0 0 0;">
		   <p style="color: #FF0000; font-family: Arial, sans-serif; font-size: 24px;">生物信息分析服务：</p>
		   <p style="color: #153643; font-family: Arial, sans-serif; font-size: 18px;padding: 0 0 0 0;">依托强大的生物信息分析平台和项目经验丰富的生物信息团队，对外承接测序原始数据的生物信息分析服务（一代测序数据、二代测序数据），生物信息分析人员与用户一对一交流，提供个性化的数据分析方案，快速响应用户的需求。根据用户的分析要求，设计适合的数据分析方案。</p>
          </td>
         </tr>
		 <tr>
          <td style="padding: 20px 0 0 0;">
		   <p style="color: #FF0000; font-family: Arial, sans-serif; font-size: 24px;">软件定制开发：</p>
		   <p style="color: #153643; font-family: Arial, sans-serif; font-size: 18px;padding: 0 0 0 0;">经验丰富的软件开发团队在现有各类强大的分析软件的基础上，可满足您对特色功能的实现、数据分析平台的构建、自定义软件的开发等需求的实现，在测序数据分析及平台构建方面助您一臂之力。</p>
          </td>
         </tr>
		</table>
       </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
         <tr>
		  <td style="font-family: Arial, sans-serif; font-size: 14px;">
			更多信息请访问：<br/>http://www.todaysoft.com.cn/ or http://www.softgenetics.com/<br/>
			联系电话：010-82600675   010-51197773-8131 <br/>
			邮箱：liuyue@todaysoft.com.cn  yanzhenchen@hsgene.com <br/>
		  ...
		  <td>
           <table border="0" cellpadding="0" cellspacing="0">
            <tr>
             <td>
              <a href="">
              <img src="http://a4.qpic.cn/psb?/V143Ct1g1kfnFK/0p6P1JQ6.RqyjEy093iAYhUVu3VuG8a2wkQoMtzJiyU!/m/dKsAAAAAAAAAnull&bo=NAISAwAAAAAFBwM!&rf=photolist&t=5" alt="二维码" width="100" height="100" style="display: block;" border="0" />
              </a>
             </td>
            </tr>
           </table>
